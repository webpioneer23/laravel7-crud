        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Starter kit</span><span class="badge badge badge-danger badge-pill float-right mr-2">New</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-1-column.html" data-i18n="1 column">1 column</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-2-columns.html" data-i18n="2 columns">2 columns</a>
                        </li>
                        <li><a class="menu-item" href="#" data-i18n="Content Detached Sidebar">Content Detached Sidebar</a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-left-sidebar.html" data-i18n="Detached left sidebar">Detached left sidebar</a>
                                </li>
                                <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-left-sticky-sidebar.html" data-i18n="Detached sticky left sidebar">Detached sticky left sidebar</a>
                                </li>
                                <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-right-sidebar.html" data-i18n="Detached right sidebar">Detached right sidebar</a>
                                </li>
                                <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-content-detached-right-sticky-sidebar.html" data-i18n="Detached sticky right sidebar">Detached sticky right sidebar</a>
                                </li>
                            </ul>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navbar.html" data-i18n="Fixed navbar">Fixed navbar</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navigation.html" data-i18n="Fixed navigation">Fixed navigation</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navbar-navigation.html" data-i18n="Fixed navbar &amp; navigation">Fixed navbar &amp; navigation</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed-navbar-footer.html" data-i18n="Fixed navbar &amp; footer">Fixed navbar &amp; footer</a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-fixed.html" data-i18n="Fixed layout">Fixed layout</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-boxed.html" data-i18n="Boxed layout">Boxed layout</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-static.html" data-i18n="Static layout">Static layout</a>
                        </li>
                        <li class="navigation-divider"></li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-light.html" data-i18n="Light layout">Light layout</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-dark.html" data-i18n="Dark layout">Dark layout</a>
                        </li>
                        <li><a class="menu-item" href="asset('starter-kit/ltr/vertical-menu-template-semi-dark/layout-semi-dark.html" data-i18n="Semi dark layout">Semi dark layout</a>
                        </li>
                    </ul>
                </li>
